...
import pandas as pd
from krtxgnn.collectors import DrugBundleAggregator
from krtxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from krtxgnn.collectors.drug_bundle import PredictedIndication
    from krtxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from krtxgnn.collectors.drug_bundle import DrugBundle
